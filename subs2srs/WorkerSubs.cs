...
namespace subs2srs
{
  ...
  class WorkerSubs
  {
    ...
    /// </summary>
    public List<List<InfoCombined>> inactivateLines(WorkerVars workerVars, IProgressReporter dialogProgress)
    {
      int totalLines = 0;
      int progessCount = 0;
    ...
    /// </summary>
    public List<List<InfoCombined>> markLinesOnlyNeededForContext(WorkerVars workerVars, IProgressReporter dialogProgress)
    {
      int totalLines = 0;
      int progessCount = 0;
    ...
    /// </summary>
    public List<List<InfoCombined>> removeInactiveLines(WorkerVars workerVars, IProgressReporter dialogProgress, bool dontRemoveContextLines)
    {
      int totalLines = 0;
      int progessCount = 0;
    ...
    /// </summary>
    public bool copyVobsubsFromPreviewDirToMediaDir(WorkerVars workerVars, IProgressReporter dialogProgress)
    {
      int totalLines = 0;
      int progessCount = 0;
